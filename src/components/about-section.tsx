        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-24 lg:items-center">
            ...
            <div className="lg:mt-0">
                ...
                <p className="mt-6 text-lg leading-8 text-foreground/80">
                    Com vasta experiência no mercado de Tecnologia da Informação, a GATTE Tecnologia é sua parceira estratégica para o sucesso. Nosso foco é entregar soluções que otimizam processos, aumentam a eficiência e garantem a segurança das operações da sua empresa. Atendemos a uma ampla gama de segmentos, oferecendo desde sistemas de gestão robustos até suporte técnico especializado, sempre com o compromisso de impulsionar o seu crescimento.
                </p>
            </div>
        </div>
      </div>
