...
export default function PacoteCompletoPage() {
  const whatsappMessage = encodeURIComponent('Olá! Tenho interesse na oferta "Pacote Completo ERP + Treinamento" (código: ERPSTART). Podemos conversar?');
      ...
      <div className="space-y-6">
        ...
        <div className="pt-4">
          <Button size="lg" asChild>
            <a href={whatsappLink} target="_blank" rel="noopener noreferrer">Garantir Pacote ERPSTART</a>
          </Button>
        </div>
      </div>
    </div>
